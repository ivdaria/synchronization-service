...
// Package mock_deleteclient is a generated GoMock package.
package mock_deleteclient
...
// DeleteAlgorithmStatus mocks base method.
func (m *MockalgorithmStatusesRepo) DeleteAlgorithmStatus(ctx context.Context, tx pgx.Tx, id int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAlgorithmStatus", ctx, tx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAlgorithmStatus indicates an expected call of DeleteAlgorithmStatus.
func (mr *MockalgorithmStatusesRepoMockRecorder) DeleteAlgorithmStatus(ctx, tx, id any) *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAlgorithmStatus", reflect.TypeOf((*MockalgorithmStatusesRepo)(nil).DeleteAlgorithmStatus), ctx, tx, id)
	return &MockalgorithmStatusesRepoDeleteAlgorithmStatusCall{Call: call}
}

// MockalgorithmStatusesRepoDeleteAlgorithmStatusCall wrap *gomock.Call
type MockalgorithmStatusesRepoDeleteAlgorithmStatusCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall) Return(arg0 error) *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall) Do(f func(context.Context, pgx.Tx, int64) error) *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall) DoAndReturn(f func(context.Context, pgx.Tx, int64) error) *MockalgorithmStatusesRepoDeleteAlgorithmStatusCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockclientsRepo) DeleteClient(ctx context.Context, tx pgx.Tx, id int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteClient", ctx, tx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteClient indicates an expected call of DeleteClient.
func (mr *MockclientsRepoMockRecorder) DeleteClient(ctx, tx, id any) *MockclientsRepoDeleteClientCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteClient", reflect.TypeOf((*MockclientsRepo)(nil).DeleteClient), ctx, tx, id)
	return &MockclientsRepoDeleteClientCall{Call: call}
}

// MockclientsRepoDeleteClientCall wrap *gomock.Call
type MockclientsRepoDeleteClientCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockclientsRepoDeleteClientCall) Return(arg0 error) *MockclientsRepoDeleteClientCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockclientsRepoDeleteClientCall) Do(f func(context.Context, pgx.Tx, int64) error) *MockclientsRepoDeleteClientCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockclientsRepoDeleteClientCall) DoAndReturn(f func(context.Context, pgx.Tx, int64) error) *MockclientsRepoDeleteClientCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
